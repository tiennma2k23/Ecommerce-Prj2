create sequence book_id_seq start 109 increment 1;
...
(
    ...
    book_gender         varchar(255) not null,
    book_title          varchar(255) not null,
    bookr               varchar(255) not null,
    price                  int4 not null,
...
alter table if exists orders_books
    add constraint FK9c3l5vucp0yrrwpc0v8vk8knt foreign key (books_id) references books;
alter table if exists orders_books
...
alter table if exists users_book_list
    add constraint FK9neiuundys2yde15o8tcybbvw foreign key (book_list_id) references books;
alter table if exists users_book_list
